# airlines-reservation-system-code-in-C++
...
{	rDiscount=0.0;
	...
	{	cout<<"\nTotal amount is RM"<<fixed<<setprecision(2)<<price;
		...
		if (couponOption==1){
			...
			{	cout<<"\nEnter your coupon\n";
				cin>>coupon;
				if (strcmp(coupon, "AEROUTTAM")==0){
					cout<<"\nSuccess, 15% off applied!";
					rDiscountB=15.0/100.0*price;
					price=price-(15.0/100.0*price);
				}
				else if (strcmp(coupon, "CAPTAINKRISHNA")==0)
				{	cout<<"\nSuccess, 5% off applied!";
					rDiscountB=5.0/100.0*price;
					price=price-(5.0/100.0*price);
				}
				else if (strcmp(coupon, "COPILOTDHARM")==0)
				{	cout<<"\nSuccess, 10% off applied!";
					rDiscountB=10.0/100.0*price;
					price=price-(10.0/100.0*price);
				}
				else if (strcmp(coupon, "STEWARDPARTH")==0)
				{	cout<<"\nSuccess, 10% off applied!";
					rDiscountB=10.0/100.0*price;
					price=price-(10.0/100.0*price);
				}
				else if ((strcmp(coupon, "AEROUTTAM ")!=0)&&(strcmp(coupon, "STEWARDPARTH")!=0)&&(strcmp(coupon, "COPILOTDHARM")!=0)&&(strcmp(coupon, "CAPTAINKRISHNA")!=0))
				{	do
					{	couponMenu=0;
			...
			} while ((strcmp(coupon, "AEROUTTAM ")!=0)&&(strcmp(coupon, "STEWARDPARTH")!=0)&&(strcmp(coupon, "COPILOTDHARM")!=0)&&(strcmp(coupon, "CAPTAINKRISHNA")!=0)&&couponMenu==0);
		}
	...
	cout<<"\n\n\n___________________________________________________________________________________________\n\n       DHARMA AIRLINES             e-Boarding Pass          [Reference Number : UITMRB370]";
	cout<<"\n__________________________________________________________________________________________\n\n      PASSENGER & FLIGHT DETAILS\n";
	cout<<"\n      "<<passenger1;
	cout<<"\n      Age "<<age1<<"        Flight  RB370               "<<mClass1;
	cout<<"\n      Seat "<<seat1;
	cout<<"\n      SURAT to "<<dest<<"    "<<time<<endl;
	if (mTicket==2||mTicket==3||mTicket==4)
	{	cout<<"\n      "<<passenger2;
...
//adult-RM1000
//kid-RM500
/*1. GERMANY  (adult = adult, kid = kid / per person)
  2. Bangkok (adult = +100, kid = +50 / per person)
  3. AUSTRALIA  (adult = +200, kid = +100 / per person)
  4. CANADA  (adult = +300, kid = +150 / per person)
  5. Paris (adult = +400, kid = +200 / per person)
  6. AMERICA  (adult = +500, kid = +250 / per person)
...
{	do
	{
		...
		cout<<"                      *                                           *\n";
		cout<<"            *        * *                                         * *        *\n";
		cout<<"           * *        *          WELCOME TO DHARMA AIRLINE        *        * *\n";
		cout<<"          *   *            *          RERSERVATION          *             *   *\n";
		cout<<"           * *            * *                              * *             * *\n";
		cout<<"            *              *                                *               *\n";
		cout<<"#############################################################################################\n";
		...
		{	cout<<"\n========== P A C K A G E S ==========\n\n____________________________________________________\n";
			...
			{	cin>>package;
				if (package=='A'||package=='a'){
					strcpy(dest, "AMERICA ");amount=3150;rDiscount=1350;rDest6=rDest6+4;
					voidPackages();
				}
				else if (package=='B'||package=='b'){
					strcpy(dest, "CANADA ");amount=3120;rDiscountA=780;rDest4=rDest4+4;
					voidPackages();
				}
				else if (package=='C'||package=='c'){
					strcpy(dest, "AUSTRALIA ");amount=2340;rDiscountA=1260;rDest3=rDest3+4;
					voidPackages();
				}
		...
		{	a=rTicketAdult;b=rTicketKid;
			cout<<"\n\n========== D H A R M A   A I R L I N E   R E P O R T ==========";
